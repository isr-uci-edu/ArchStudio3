...
public class DistHostDescription{
	...
	public static String getXml(){
		...
		archStructure.setId("ArchStudio_3_DistHost");
		archStructure.setDescription(createDescription("ArchStudio 3.0 Distributed Host Architecture"));
		...
		//);
		archTypes.addComponentType(
			createComponentType("DistHost_type", "Distributed Host Type", "archstudio.comp.disthost.DistributedHostC2Component")
		);
		...
		//);
		archStructure.addComponent(
			createComponent("DistHost", "Distributed Host Stub", "DistHost_type")
		);
		archStructure.addConnector(
			createConnector("DistHostBus", "Distributed Host Bus", "BusConnector_type")
		);
		archStructure.addConnector(
			createFredConnector("DistHostFredConnector", "Distributed Host Fred Connector")
		);

		archStructure.addLink(createLink("DistHost", "DistHostBus"));
		
		archStructure.addLink(createLink("DistHostBus", "IFACE_BOTTOM", "DistHostFredConnector", "IFACE_LOCAL"));
