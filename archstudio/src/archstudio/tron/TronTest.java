...
public class TronTest implements java.io.Serializable{
	protected String uid;
	protected String toolID;
	protected String category;
	protected String longDescription;

	public TronTest(String uid, String toolID, String category, String longDescription){
		super();
		this.uid = uid;
		this.toolID = toolID;
	...
	public String toString(){
		StringBuffer sb = new StringBuffer("TronTest[");
	...
	public boolean equals(Object o){
		if(!(o instanceof TronTest)){
			return false;
		}
		TronTest otherTest = (TronTest)o;
