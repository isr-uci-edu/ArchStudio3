...
public class SecureCoalitionDataMgrC2Component extends AbstractC2DelegateBrick 
    implements InvokableBrick, c2.fw.Component
{
    public static final String PRODUCT_NAME = 
        "Coalition Demo Data Manager Component";
	public static final String SERVICE_NAME = "Demos/Secure Coalition Demo Data Manager";
    ...
    public SecureCoalitionDataMgrC2Component( Identifier id )
    {
        super( id );
    ...
    private class CoalitionDataMgrFrame extends JFrame 
        ...
        public void checkURL (String strURL) 
        {
            ...
            try {
                ...
                } else if (fileName.endsWith("/USFrance-instantiate.xml")) {
                    // assume filename of diff url
                    frenchArchURL = strURL;
                    frenchDiffURL = strURL.replaceAll("USFrance-instantiate.xml",
                                                      "USFrance-diff.xml");
