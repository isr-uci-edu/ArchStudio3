...
import edu.uci.ics.bna.GlowboxThing;
import edu.uci.ics.bna.IOffset;
import edu.uci.ics.bna.Thing;
import edu.uci.ics.bna.ThingLogicAdapter;

public class GlowboxOffsetRotatorLogic extends ThingLogicAdapter{

	protected OffsetRotatorLogic rotator = null;
	
	public GlowboxOffsetRotatorLogic(OffsetRotatorLogic rotator){
