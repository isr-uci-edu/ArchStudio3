...
public class ReshapeHandleThing extends AbstractThing implements ICustomCursor{
	...
	public ReshapeHandleThing(){
		super(c2.util.UIDGenerator.generateUID("ReshapeHandleThing"));
		setX(0);
		setY(0);
	...
	public Class getPeerClass(){
		return ReshapeHandleThingPeer.class;
	}
